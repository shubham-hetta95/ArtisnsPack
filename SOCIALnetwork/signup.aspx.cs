...
namespace SOCIALnetwork
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void joinpack(object sender, EventArgs e)
        {
            if (checkMemberExists())
            {
                Label3.Text = "Username taken. Chose another";
                Label2.Text = "";
            }
            else
            {
        ...
        bool checkMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from member_master where username='" + username.Text.Trim() + "';", con);
        ...
        void signupNewUser()
        {
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("insert into member_master (username,name,email,password,art,ques,ans) values(@uname,@name,@email,@password,@art,@quest,@answ)", con);
