...
namespace SOCIALnetwork
{
    public partial class Art : System.Web.UI.Page
    {
        ...
        {
            if (Session["explore"].ToString() == "Painting")
            {
                Label4.Text = Session["explore"].ToString();

            }
            else if (Session["explore"].ToString() == "Sketching")
            {
                Label4.Text = Session["explore"].ToString();
            }
            else if (Session["explore"].ToString() == "Writing")
            {
                Label4.Text = Session["explore"].ToString();
              
            }

            else if (Session["explore"].ToString() == "Photography")
            {
                Label4.Text = Session["explore"].ToString();
            }
            else if (Session["explore"].ToString() == "Craft")
            {
                Label4.Text = Session["explore"].ToString();
            }
        }
        ...
        protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "likecount")
            {
                ...
                Response.Write(l);
                Response.Write(GridView1.Rows[l].Cells[0].Text);
